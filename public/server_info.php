                ...
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
                    ...
                    <fieldset>
                        <table class="table">
                            <thead>
                                <tr>
                                    <td width="35%"><b><?php echo $text_setting; ?></b>
                                    </td>
                                    <td width="25%"><b><?php echo $text_current; ?></b>
                                    </td>
                                    <td width="25%"><b><?php echo $text_required; ?></b>
                                    </td>
                                    <td width="15%" class="text-center"><b><?php echo $text_status; ?></b>
                                    </td>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td><?php echo $text_memory_limit; ?>
                                    </td>
                                    <td><?php echo ini_get('memory_limit'); ?>
                                    </td>
                                    <td>32M or 32M+</td>
                                ...
                                <tr>
                                    <td><?php echo $text_version; ?>
                                    </td>
                                    <td><?php echo $php_version; ?>
                                    </td>
                                    <td>7.4</td>
                                    <td class="text-center"><?php if ($php_version >= '7.4' && $php_version < '7.5') { ?>
                                            <span class="text-success"><i class="fa fa-check-circle svg-icn check"><svg class="icon icon--check">
                                ...
                                <tr>
                                    <td><?php echo $text_allow_url_fopen; ?>
                                    </td>
              ...
              <tr>
                ...
                <td class="text-center"><?php if (!$safeModeOn) { ?>
                  ...
                  <?php } ?>
                                ...
                                <tr>
                                    <td><?php echo $text_rewrite_url; ?>
                                        (Optional) If
                                        Off, then SEO URLs will not work.</td>
                    ...
                    <p><?php echo $text_install_extension; ?>
                    </p>
                    <fieldset>
                        <table class="table">
                            <thead>
                                <tr>
                                    <td width="35%"><b><?php echo $text_extension; ?></b>
                                    </td>
                                    <td width="25%"><b><?php echo $text_current; ?></b>
                                    </td>
                                    <td width="25%"><b><?php echo $text_required; ?></b>
