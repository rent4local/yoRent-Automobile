...
FatApplication::getInstance()->setControllersForStaticFileServer(array('images', 'fonts', 'js', 'img', 'innovas','assetmanager', 'assets'));
...
$innova_settings  =  array('width'=>'650', 'height'=>'400','arrStyle'=>'[["body",false,"","min-height:250px;"]]',  'groups'=>' [
    ...
    'css'=> '"'.CONF_WEBROOT_URL.'assets/innovas/styles/default.css"',
