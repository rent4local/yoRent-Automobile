...
<div class='page'>
                ...
                <div class="page__title">
                    <div class="row">
                        <div class="col--first col-lg-6">
                            ...
                            <h5><?php echo Labels::getLabel('LBL_Advertisers_Report', $adminLangId); ?>
                            </h5>
	...
	<div class="col-sm-12">-->
                <section class="section searchform_filter">
                    ...
                    <div class="sectionbody space togglewrap" style="display:none;">
                        <?php
                            $frmSearch->setFormTagAttribute('onsubmit', 'searchAdvertisersReport(this); return(false);');
	...
	<div class="col-sm-12">-->
                <section class="section">
                    <div class="sectionhead">
                        <h4><?php echo Labels::getLabel('LBL_Advertisers_Report', $adminLangId); ?>
                        </h4>
                        <?php
                            $data = [
