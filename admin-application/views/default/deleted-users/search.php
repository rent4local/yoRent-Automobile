        ...
        switch ($key) {
            ...
            case 'action':
                ...
                if ($canEdit) {
                    ...
                    $td->appendElement('a', array('href' => 'javascript:void(0)', 'class' => 'btn btn-clean btn-sm btn-icon', 'title' => Labels::getLabel('LBL_Restore_User', $adminLangId), "onclick" => "restoreUser(" . $row['user_id'] . ")"), '<i class="fas fa-recycle"></i>', true);
                }
                break;
            default:
