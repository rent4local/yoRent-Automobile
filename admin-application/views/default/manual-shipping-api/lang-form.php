...
$langFld->setfieldTagAttribute('onChange', "manualShippingLangForm(" . $mshipapi_id . ", this.value);");
?>
<div class="col-sm-12">
	...
	<div class="tabs_nav_container responsive flat">
		<ul class="tabs_nav">
            ...
            <li class="<?php echo (0 == $mshipapi_id) ? 'fat-inactive' : ''; ?>">
                            ...
                            <div class="row justify-content-end"> 
                                <div class="col-auto mb-4">
                                    <input class="btn btn-brand" 
                                        ...
                                        onClick="manualShippingLangForm(<?php echo $mshipapi_id; ?>, <?php echo $lang_id; ?>, 1)">
                                </div>
                            </div>
                        <?php } ?> 
