    ...
    <tbody>
            ...
            <table width="100%">
                <tbody>
                    <tr>
                        ...
                        <td align="right" valign="middle"><?php echo Labels::getlabel('LBL_Order_details', $adminLangId); ?></td>
                    </tr>
                </tbody>
            </table>
        </tr>
        ...
        <tr>
            <table width="100%">
                <tbody>
                    <tr>
                        <td><strong><?php echo Labels::getLabel('LBL_Date', $adminLangId); ?>:</strong>
                            <font size="10"><?php echo FatDate::format($orderDetail['order_date_added']); ?></font>
                        </td>
                        <td align="right"><strong><?php echo Labels::getLabel('LBL_Order_Id', $adminLangId); ?>:</strong>
            ...
            <table width="100%">
                <tbody>
                    <tr>
                        ...
                        ?>
                        <td width="45%"><strong><?php echo Labels::getLabel('LBL_Bill_To', $adminLangId); ?>:</strong>
                            <br>
                        ...
                        ?>
                            <td width="45%" align="right"><strong><?php echo Labels::getLabel('LBL_Ship_To', $adminLangId); ?>:</strong>
                                <br>
                        ...
                        ?>
                            <td width="45%" align="right"><strong><?php echo Labels::getLabel('LBL_Pick_Up', $adminLangId); ?>:</strong>
                                <br>
        ...
        <tr>
            <table width="100%">
                <tbody>
                    <tr>
                        <td><strong>
                                <font size="10"><?php echo Labels::getLabel('LBL_Order', $adminLangId); ?>:</font>
                            </strong>
                            <br><span>
                        ...
                        <!-- <td><strong>
                                <font size="10"><?php echo Labels::getLabel('LBL_Order_Date', $adminLangId); ?>:</font>
                            </strong>
                            <br><span>
                                <font size="10"><?php echo FatDate::format($orderDetail['order_date_added']); ?></font>
                            </span>
                        </td> -->
                        <?php if ($orderDetail['opd_sold_or_rented'] == applicationConstants::PRODUCT_FOR_RENT) { ?>
                            ...
                            ?>
                            <td><strong>
                                    <font size="10"><?php echo Labels::getLabel('LBL_From', $adminLangId); ?>:</font>
                                </strong>
                                <br><span>
                            ...
                            <td><strong>
                                    <font size="10"><?php echo Labels::getLabel('LBL_To', $adminLangId); ?>:</font>
                                </strong>
                                <br><span>
                        ...
                        ?>
                        <td><strong>
                                <font size="10"><?php echo Labels::getLabel('LBL_Payment_Method', $adminLangId); ?>:</font>
                            </strong>
                            <br><span>
                        ...
                        <?php /* if ($orderDetail['opd_sold_or_rented'] == applicationConstants::ORDER_TYPE_RENT) { ?>
                            <td align="right"><strong>
                                    <font size="10"><?php echo Labels::getLabel('LBL_Duration', $adminLangId); ?>:</font>
                                </strong>
                                <br><span>
                                    <font size="10"><?php echo $duration . ' ' . Labels::getLabel('LBL_Days', $adminLangId); ?></font>
                                </span>
                            </td>
                        <?php } */ ?>
                    </tr>
                ...
                <thead>
                    <tr>
                        <th width="<?php echo $namesection; ?>"><strong>
                                <font size="10"><?php echo Labels::getLabel('LBL_Item', $adminLangId); ?></font>
                            </strong></th>
                        <th width="<?php echo $qtyWidth; ?>"><strong>
                                <font size="10"><?php echo Labels::getLabel('LBL_Qty', $adminLangId); ?></font>
                            </strong></th>
                            <?php if ($orderDetail['order_is_rfq'] == applicationConstants::NO) { ?>
                                <th width="<?php echo $priceWidth; ?>"><strong>
                                    <font size="10"><?php echo ($orderDetail['opd_sold_or_rented'] == applicationConstants::PRODUCT_FOR_RENT) ? Labels::getLabel('LBL_Unit_Price', $adminLangId) : Labels::getLabel('LBL_Price', $adminLangId); ?></font>
                                    </strong>
                                </th>
                            <?php } ?>
                        <?php if ($isRentOrder) { ?>
                        ...
                        <th width="<?php echo $totalWidth; ?>" align="right"><strong>
                                <font size="10"><?php echo Labels::getLabel('LBL_Total_Amount', $adminLangId); ?></font>
                                <?php if ($isRentOrder && $orderDetail['order_is_rfq'] == applicationConstants::NO) { 
                                    echo '<font size="8">('. Labels::getLabel('LBL_Total_Amount_tooltip', $adminLangId). ')</font>'; 
                                } ?>
                            </strong></th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td width="<?php echo $namesection; ?>">
                            ...
                            <br>
                            <font size="10"><strong><?php echo Labels::getLabel('LBL_Brand', $adminLangId); ?>:</strong> <?php echo CommonHelper::displayNotApplicable($adminLangId, $orderDetail['op_brand_name']); ?></font>
                            <br>

                            <?php if ($orderDetail['op_selprod_options'] != '') { ?>
                                <font size="10"><strong><?php echo Labels::getLabel('LBL_Option', $adminLangId); ?>:</strong> <?php echo $orderDetail['op_selprod_options']; ?></font>
                                <br>
                            <?php } ?>

                            <?php if ($orderDetail['op_shipping_duration_name'] != '') { ?>
                                <font size="10"><strong><?php echo Labels::getLabel('LBL_Shipping_Method', $adminLangId); ?>:</strong> <?php echo $orderDetail['op_shipping_durations'] . '-' . $orderDetail['op_shipping_duration_name']; ?></font>
                                <br>
                            <?php }
                            ?>

                            <font size="10"><strong><?php echo Labels::getLabel('LBL_Sold_By', $adminLangId); ?>:</strong> <?php echo $orderDetail['op_shop_name']; ?></font>

                            <?php if (!empty($attachedServices)) { ?>
                                <br>
                                <br>
                                <font size="10"><strong><?php echo Labels::getLabel('LBL_Addons', $adminLangId); ?>:</strong></font>
        ...
        <tr>
            <table width="100%" align="right">
                <tbody>
                    <tr>
                        <td width="75%">
                            <font size="10"><strong><?php echo Labels::getLabel('LBL_Cart_Total', $adminLangId); ?></strong></font>
                        </td>
                        <td width="5%">
                    ...
                    <?php if ($addonTotal > 0) { ?>
                        <tr>
                            <td width="75%">
                                <font size="10"><strong><?php echo Labels::getLabel('LBL_Addon_Total', $adminLangId); ?></strong></font>
                            </td>
                            <td width="5%">
                                <font size="10"><strong>:</strong></font>
                            </td>
                    ...
                    <?php if ($durationDiscountAmount != 0) { ?>
                        <tr>
                            <td width="75%">
                                <font size="10"><strong><?php echo Labels::getLabel('LBL_Duration_Discount', $adminLangId); ?></strong></font>
                            </td>
                            <td width="5%">
                                <font size="10"><strong>:</strong></font>
                            </td>
                    ...
                    <?php if ($volumnDiscountAmount != 0) { ?>
                        <tr>
                            <td width="75%">
                                <font size="10"><strong><?php echo Labels::getLabel('LBL_Volume_Discount', $adminLangId); ?></strong></font>
                            </td>
                            <td width="5%">
                                <font size="10"><strong>:</strong></font>
                            </td>
                    ...
                    <?php if ($totalSecurityAmount > 0) { ?>
                        ...
                        <tr>
                            <td width="75%">
                                <font size="10"><strong><?php echo Labels::getLabel('LBL_Security_Amount', $adminLangId); ?></strong></font>
                            </td>
                            <td width="5%">
                                <font size="10"><strong>:</strong></font>
                            </td>
                    ...
                    <?php if ($shippingCharges > 0 && CommonHelper::canAvailShippingChargesBySeller($orderDetail['op_selprod_user_id'], $orderDetail['opshipping_by_seller_user_id'])) { ?>
                        <tr>
                            <td width="75%">
                                <font size="10"><strong><?php echo Labels::getLabel('LBL_Shipping_Price', $adminLangId); ?></strong></font>
                            </td>
                            <td width="5%">
                                <font size="10"><strong>:</strong></font>
                            </td>
                    ...
                    <?php if ($orderDetail['op_tax_collected_by_seller']) { ?>
                        <tr>
                            <td width="75%">
                                <font size="10"><strong><?php echo Labels::getLabel('LBL_Taxes', $adminLangId); ?></strong></font>
                            </td>
                            <td width="5%">
                                <font size="10"><strong>:</strong></font>
                            </td>
                    ...
                    <?php if ($roundingOffTotal > 0) { ?>
                        <tr>
                            <td width="75%">
                                <font size="10"><strong><?php echo Labels::getLabel('LBL_Rounding_Up', $adminLangId); ?></strong></font>
                            </td>
                            <td width="5%">
                                <font size="10"><strong>:</strong></font>
                            </td>
                    ...
                    <?php } elseif (0 > $roundingOffTotal) { ?>
                        <tr>
                            <td width="75%">
                                <font size="10"><strong><?php echo Labels::getLabel('LBL_Rounding_Down', $adminLangId); ?></strong></font>
                            </td>
                            <td width="5%">
                                <font size="10"><strong>:</strong></font>
                            </td>
                    ...
                    <?php if ($couponDiscount != 0) { ?>
                        ...
                        <tr>
                            <td width="75%">
                                <font size="10"><strong><?php echo Labels::getLabel('LBL_Discount', $adminLangId); ?></strong></font>
                            </td>
                            <td width="5%">
                                <font size="10"><strong>:</strong></font>
                            </td>
                    ...
                    <?php if ($rewardPointTotal != 0) { ?>
                        <tr>
                            <td width="75%">
                                <font size="10"><strong><?php echo Labels::getLabel('LBL_Reward_Point_Discount', $adminLangId); ?></strong></font>
                            </td>
                            <td width="5%">
                                <font size="10"><strong>:</strong></font>
                            </td>
                    ...
                    <tr>
                        <td width="75%">
                            <font size="12"><strong><?php echo Labels::getLabel('LBL_Order_Total_Amount', $adminLangId); ?></strong></font>
                        </td>
                        <td width="5%">
                            <font size="10"><strong>:</strong></font>
                        </td>
        ...
        <tr>
            <table>
                <tbody>
                    <tr>
                        <td>
                            <font size="10"><strong><?php echo Labels::getLabel('LBL_Authorized_Signatory', $adminLangId); ?></strong></font>
                        </td>
                    </tr>
                </tbody>
            </table>
        ...
        if (FatApp::getConfig("CONF_ADDRESS_ON_ORDER_DETAIL_PRINT") == User::USER_TYPE_SELLER) {
            ...
            $officeAddress = nl2br(FatApp::getConfig('CONF_ADDRESS_' . $adminLangId, FatUtility::VAR_STRING, ''));
            $govInfo = nl2br(FatApp::getConfig('CONF_GOV_INFO_ON_INVOICE', FatUtility::VAR_STRING, ''));
        }
        ?>
        <tr>
            <table width="100%">
                <tbody><tr><td><font size="9"><strong><?php echo Labels::getLabel('LBL_Regd._Office', $adminLangId); ?>: </strong><?php echo $officeAddress; ?></font>
                        </td>
                        <?php
                        ...
                        ?>
                            ...
                            <td align="right">
                                <font size="9"><strong><?php echo Labels::getLabel('LBL_Contact', $adminLangId); ?>:</strong><?php
                                                                                                                                if ($site_conatct) {
                                                                                                                                    echo $site_conatct;
                                                                                                                                }
                                                                                                                                ?>
                                    ...
                                    ?></font>
                                    <br>
                                 <font size="9"><strong><?php echo Labels::getLabel('LBL_Other_Details', $adminLangId); ?>:</strong> <?php echo $govInfo; ?></font>
                            </td>
                        <?php } ?>
                    </tr>
                </tbody>
