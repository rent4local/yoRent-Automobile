        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 space">
                <div class="page__title">
                    <div class="row">
                        <div class="col--first col-lg-6">
                            ...
                            <h5><?php echo Labels::getLabel('LBL_Seller_Products_Rental_Unavailable_Dates', $adminLangId); ?> </h5>
                            <small class="note">(<?php echo Labels::getLabel('LBL_Valid_Only_With_Rental_Products', $adminLangId); ?>)</small>
                            <?php $this->includeTemplate('_partial/header/header-breadcrumb.php', array("removeHref"=>"seller-rental-products")); ?>
                        </div>
                    </div>
                </div>
                ...
                <section class="section">
                    <div class="sectionhead">
                        <h4><?php echo Labels::getLabel('LBL_Seller_Products_Rental_Unavailable_Dates_listing', $adminLangId); ?> </h4>
                        <?php
                        if ($canEdit) {
                            $data = [
