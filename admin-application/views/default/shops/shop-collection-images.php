...
<?php if (!empty($images)) { ?>
    <div class="logoWrap">
    <div class="logothumb"> <img src="<?php echo UrlHelper::generateUrl('Image', 'shopCollectionImage', array($images['afile_record_id'], $images['afile_lang_id'], 'THUMB'), CONF_WEBROOT_FRONT_URL);?>" alt="<?php echo Labels::getLabel('LBL_Collection_Image', $adminLangId);?>">
