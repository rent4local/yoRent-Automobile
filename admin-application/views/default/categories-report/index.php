...
<div class='page'>
                ...
                <div class="page__title">
                    <div class="row">
                        <div class="col--first col-lg-6">
                            ...
                            <h5><?php echo Labels::getLabel('LBL_Categories_Report', $adminLangId); ?>
                            </h5>
	...
	<div class="col-sm-12">-->
                <section class="section">
                    <div class="sectionhead">
                        <h4 class="report-heading--js"><?php echo Labels::getLabel('LBL_Top_Categories_Report', $adminLangId); ?></h4>
                        <?php
                            $data = [
