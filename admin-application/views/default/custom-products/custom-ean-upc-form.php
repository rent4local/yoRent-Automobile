        ...
        <tbody class="scroll-y">
            ...
            ?>
                <tr>
                    ...
                    <td><input type="text" id="code<?php echo $optionValueId; ?>" name="code<?php echo $optionValueId?>" value="<?php echo (isset   ($upcCodeData[$optionValueId]))?$upcCodeData[$optionValueId]:'';?>" onBlur="updateUpc('<?php echo $preqId; ?>','<?php echo $optionValueId;?>')"></td>
                </tr>
            <?php } ?>
        </tbody>
    </table>
            ...
            <div class="field-set">
                ...
                <div class="field-wraper">
                    <div class="field_cover">
                        <input type="text" id="code0" name="code0" value="<?php echo (isset($upcCodeData[0]['upc_code'])) ? $upcCodeData[0]['upc_code'] : ''; ?>" onBlur="updateUpc('<?php echo $preqId; ?>','0')">
                    </div>
                </div>
            </div>
        </div>
