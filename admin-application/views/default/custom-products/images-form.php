...
if (!empty($img_fld)) {
    $img_fld->addFieldTagAttribute('onChange', 'popupSizeChart(this)');
}
?>
...
<section class="section" id="mediaForm-js">
    ...
    <div class="sectionbody space">
            ...
            <div class="col-sm-12">
                <div class="tabs_nav_container responsive flat">
                    <div class="tabs_panel_wrap">
                        <div class=""> <?php echo $imagesFrm->getFormHtml(); ?> </div>
                        <div id="imageupload_div" class="padd15">
                            <?php if (!empty($product_images)) { ?>
                                <ul class="grids--onefifth ui-sortable" id="<?php echo ($canEdit) ? 'sortable' : ''; ?>
                                <?php $count = 1;
        ...
        if ($canEdit) {
            ?>
                                                    <a class="deleteLink white" href="javascript:void(0);"
                                                       title="Delete <?php echo $row['afile_name']; ?>" onclick="deleteProductImage(<?php echo $row['afile_record_id']; ?>, <?php echo $row['afile_id']; ?>);" class="delete"><i class="ion-close-round"></i></a>
                                            <?php } ?>
                                            </div>
                                            <?php
