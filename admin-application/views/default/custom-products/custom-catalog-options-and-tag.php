    ...
    <div class="row tabs_footer">
        <div class="col-6">
            <div class="field-set">
                ...
                <div class="field-wraper">
                    <div class="field_cover">
                        <input type="button" class="btn btn-outline-brand" onClick= "productAttributeAndSpecificationsFrm(<?php echo $preqId; ?>)" value="<?php echo Labels::getLabel('LBL_Back', $adminLangId); ?>">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="field-set">
                ...
                <div class="field-wraper">
                    <div class="field_cover">
                        ...
                        <input type="button" class="btn btn-brand" onClick= "productShipping(<?php echo $preqId; ?>)" value="<?php echo Labels::getLabel('LBL_Save_And_Next', $adminLangId); ?>">
                    </div>
                </div>
            </div>
        </div>
       ...
       upcListing(preq_id);
        ...
        addTagData = function (e) {
            ...
            if (tag_id == '') {
                ...
                fcom.updateWithAjax(fcom.makeUrl('CustomProducts', 'setupTag'), data, function (t) {
                    var dataLang = 'tag_id=' + t.tagId + '&tag_name=' + tag_name + '&lang_id=0';
                    fcom.updateWithAjax(fcom.makeUrl('CustomProducts', 'tagLangSetup'), dataLang, function (t2) {
                        fcom.updateWithAjax(fcom.makeUrl('CustomProducts', 'updateCustomCatalogTag'), 'preq_id=' + preq_id + '&tag_id=' + t.tagId, function (t3) {
                ...
                fcom.updateWithAjax(fcom.makeUrl('CustomProducts', 'updateCustomCatalogTag'), 'preq_id=' + preq_id + '&tag_id=' + tag_id, function (t) { });
            }
        }
        ...
        getTagsAutoComplete = function(e){
            ...
            var list = [];
            fcom.ajax(fcom.makeUrl('CustomProducts', 'tagsAutoComplete'), {keyword:keyword}, function(t) {          
                var ans = $.parseJSON(t);
        ...
        getOptionsAutoComplete = function(e){
            ...
            var listOptions = [];
            fcom.ajax(fcom.makeUrl('CustomProducts', 'autoCompleteOptions',[<?php echo $preq_user_id;?>]), {keyword:keyword}, function(t) {           
                var ans = $.parseJSON(t);
                for (i = 0; i < ans.length; i++) {            
                    listOptions.push({
                        "id" : ans[i].id,
