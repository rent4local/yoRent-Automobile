...
$arr_flds = array(	
	...
	'totUserOrderQtys'=>Labels::getLabel('LBL_Bought_Qty',$adminLangId),				
	'totSoldQty'=>Labels::getLabel('LBL_Sold_Qty',$adminLangId),				
	'totUserOrders'=>Labels::getLabel('LBL_Orders_Placed',$adminLangId),				
	'totVendorOrders'=>Labels::getLabel('LBL_Orders_Received',$adminLangId),				
	'totUserOrderPurchases'=>Labels::getLabel('LBL_Purchases',$adminLangId),
	'totalVendorSales'=>Labels::getLabel('LBL_Sales',$adminLangId),
...
foreach ($arr_listing as $sn=>$row){ 
	...
	foreach ($arr_flds as $key=>$val){
		...
		switch ($key){
			...
			case 'totUserOrderPurchases':
			case 'totalVendorSales':
			case 'totUserBalance':			
...
echo FatUtility::createHiddenFormFromData ( $postedData, array (
		'name' => 'frmUsersReportSearchPaging'
) );
