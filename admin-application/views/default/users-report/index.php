    ...
    <div class='container container-fluid'>
        <div class="row">
            <div class="col-lg-12 col-md-12 space">
                <div class="page__title">
                    <div class="row">
                        <div class="col--first col-lg-6">
                            ...
                            <h5><?php echo Labels::getLabel('LBL_Users_Report', $adminLangId); ?>
                            </h5>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h1><?php //echo Labels::getLabel('LBL_View_Users_Report',$adminLangId);?>
                        </h1>
                        <section class="section searchform_filter">
                            ...
                            <div class="sectionbody space togglewrap" style="display:none;">
                                <?php
                                    $frmSearch->setFormTagAttribute('onsubmit', 'searchUsersReport(this); return(false);');
                    ...
                    <div class="col-sm-12">
                        <section class="section">
                            <div class="sectionhead">
                                <h4><?php echo Labels::getLabel('LBL_Users_Report', $adminLangId); ?></h4>
