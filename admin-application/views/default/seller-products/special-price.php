                ...
                <section class="section">
                    ...
                    <div class="sectionbody">
                        ...
                        foreach ($dataToEdit as $data) {
                            ...
                            $this->includeTemplate('seller-products/add-special-price-form.php', array('adminLangId' => $adminLangId, 'data' => $data, 'productFor' => $productFor), false);
                        }

                        if (1 > $selProd_id) {
                            $this->includeTemplate('seller-products/add-special-price-form.php', array('adminLangId' => $adminLangId, 'productFor' => $productFor), false);
                        }
                        ?>
                        <div class="tablewrap">
