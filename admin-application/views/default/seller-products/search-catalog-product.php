    ...
    foreach ($arr_flds as $key => $val) {
        ...
        switch ($key) {
            ...
            case 'action':
                ...
                $td->appendElement(
                    'a',
                    array('href' => UrlHelper::generateUrl('sellerProducts', 'index', array($row['product_id'])), 'class' => 'btn btn-brand btn-sm', 'title' => Labels::getLabel('LBL_Pick_to_Sell', $adminLangId)),
                    Labels::getLabel('LBL_Pick_to_Sell', $adminLangId),
                    true
                );
                break;
            default:
