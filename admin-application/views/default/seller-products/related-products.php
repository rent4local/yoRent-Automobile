            ...
            <div class="col-lg-12 col-md-12 space">
                <div class="page__title">
                    <div class="row">
                        <div class="col--first col-lg-6">
                            ...
                            <h5><?php echo Labels::getLabel('LBL_Related_Products', $adminLangId); ?> </h5>
                ...
                <section class="section">
                    <div class="sectionbody space togglewrap">
                        ...
                        $relProdFld->setFieldTagAttribute('placeholder', Labels::getLabel('LBL_Add_Related_Products', $adminLangId));
