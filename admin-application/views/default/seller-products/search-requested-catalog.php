        ...
        foreach ($arr_flds as $key => $val) {
            ...
            switch ($key) {
                ...
                case 'action':
                    ...
                    $li->appendElement(
                        'a',
                        array('href' => 'javascript:void(0)', 'onClick' => 'viewRequestedCatalog(' . $row['scatrequest_id'] . ')', 'class' => '', 'title' => Labels::getLabel('LBL_View', $adminLangId)),
                        '<i class="fa fa-eye"></i>',
                        true
                    );
                    if ($row['scatrequest_status'] == User::CATALOG_REQUEST_PENDING) {
                        ...
                        $li->appendElement(
                            'a',
                            array('href' => 'javascript:void(0)', 'onClick' => 'deleteRequestedCatalog(' . $row['scatrequest_id'] . ')', 'class' => '', 'title' => Labels::getLabel('LBL_Delete', $adminLangId)),
                    ...
                    $li->appendElement(
                        'a',
                        array('href' => 'javascript:void(0)', 'onClick' => 'messageForm(' . $row['scatrequest_id'] . ')', 'class' => '', 'title' => Labels::getLabel('LBL_Messages', $adminLangId)),
