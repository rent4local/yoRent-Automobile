$(document).ready(function () {
  ...
  $(
    ".themebtn, .leftmenu > li > a, .actions > li > a, .leftlinks > li > a, .profilecover .profileinfo, .pagination li a, .circlebutton, .columlist li a"
  ).click(function (e) {
    parent = $(this);
  ...
  floatLabel(
    ".web_form input[type='text'], .web_form input[type='password'], .web_form input[type='email'], .web_form select, .web_form textarea, .web_form input[type='file']"
  );
  ...
  $(".tabs_nav li a").click(function () {
    ...
    $(this)
      .parents(".tabs_nav_container:first")
      .find(".tabs_nav li a")
      .removeClass("active");
    $(this).addClass("active");
  ...
  $(".togglehead").click(function () {
    ...
    $(window).scrollTop(
      $(this).parents(".tabs_panel_wrap:first").offset().top - 50
    );
    if ($(this).hasClass("active")) {
      $(".togglehead").removeClass("active");
      $(this)
  ...
  $(".accordians_container")
    .find(".accordianhead:first")
    .addClass("active")
    .next()
...
$('.accordianhead').click(function() { */
  $(document).on("click", ".accordianhead", function () {
    if ($(this).next().is(":hidden")) {
      ...
      $(this)
        .parents(".accordians_container:first")
        .find(".accordianhead")
        .removeClass("active")
        .next()
  ...
  $(document).on(
    "click",
    ".togglelink a, .section.searchform_filter .sectionhead",
    function () {
  ...
  $(document).on("click", ".selectItem--js", function () {
    ...
    if (
      $("#" + parentForm + " .selectItem--js").length ==
      $("#" + parentForm + " .selectItem--js:checked").length
    ) {
...
changeRfqStatus = function (rfqId) {
  if (!confirm(langLbl.confirmCancelRfq)) {
    return;
  }
  var data = "rfq_id=" + rfqId;
  fcom.ajax(
    fcom.makeUrl("RequestForQuotes", "changeStatus"),
    data,
    function (res) {
