...
$langFld->setfieldTagAttribute('onChange', "shippingDurationLangForm(" . $sduration_id . ", this.value);");
?>
                            ...
                            <div class="row justify-content-end"> 
                                <div class="col-auto mb-4">
                                    <input class="btn btn-brand" 
                                        ...
                                        onClick="shippingDurationLangForm(<?php echo $sduration_id; ?>, <?php echo $lang_id; ?>, 1)">
                                </div>
                            </div>
                        <?php } ?> 
