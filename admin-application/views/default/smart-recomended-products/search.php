    ...
    foreach ($arr_flds as $key => $val) {
        ...
        switch ($key) {
            ...
            case 'spw_custom_weightage':
                ...
                $fld->setFieldTagAttribute('onchange', 'saveData(\'' . $row['spw_product_id'] . '\', this, \'spw_custom_weightage\')');
            ...
            case 'spw_custom_weightage_valid_till':
                ...
                $tillDateFrm->addDateField('', 'spw_custom_weightage_valid_till', $row[$key], array('onchange' => 'saveData(\'' . $row['spw_product_id'] . '\', this, \'spw_custom_weightage_valid_till\')', 'readonly' => 'readonly'));
                if (!$canEdit) {
                    $fld = $tillDateFrm->getField('spw_custom_weightage_valid_till');
                    $fld->setFieldTagAttribute('disabled', 'disabled');
                }
