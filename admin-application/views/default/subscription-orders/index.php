            ...
            <div class="col-lg-12 col-md-12 space">
                ...
                <section class="section searchform_filter">
                    ...
                    <div class="sectionbody space togglewrap" style="display:none;">
                        <?php
                        $frmSearch->setFormTagAttribute('onsubmit', 'searchSubscriptionOrders(this,1); return(false);');
                        ...
                        $sellerFld->htmlAfterField = '<small></small>';
                ...
                <section class="section">
                    <div class="sectionhead">
                        <h4><?php echo Labels::getLabel('LBL_Subscriptions_List', $adminLangId); ?> </h4>
                    </div>
                    <div class="sectionbody">
                        <div class="tablewrap">
                            <div id="SubscriptionOrdersListing">
