...
<div class="col-sm-12">
	...
	<div class="tabs_nav_container responsive flat">
		<ul class="tabs_nav">
            ...
            <li class="<?php echo (0 == $testimonial_id) ? 'fat-inactive' : ''; ?>">
                <a href="javascript:void(0);" <?php echo (0 < $testimonial_id) ? "onclick='editTestimonialLangForm(" . $testimonial_id . "," . FatApp::getConfig('conf_default_site_lang', FatUtility::VAR_INT, 1) . ");'" : ""; ?>>
