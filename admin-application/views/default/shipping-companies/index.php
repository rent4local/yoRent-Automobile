            ...
            <div class="col-lg-12 col-md-12 space">
                <div class="page__title">
                    <div class="row">
                        <div class="col--first col-lg-6">
                            ...
                            <h5><?php echo Labels::getLabel('LBL_Manage_Shipping_Companies', $adminLangId); ?> </h5>
                ...
                <section class="section">
                    ...
                    <div class="sectionbody">
                        <div class="tablewrap">
                            <div id="sCompanyListing"> <?php echo Labels::getLabel('LBL_Processing...', $adminLangId); ?> </div>
                        </div>
                    </div>
                </section>
            </div>
