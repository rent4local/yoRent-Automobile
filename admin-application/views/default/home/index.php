    ...
    <div class="page">
        <div class="container container-fluid">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4 mb-4">
                    <div class="box box--white box--stats d-block">
                        <div class="box__body">
                            <img src="<?php echo CONF_WEBROOT_FRONT_URL; ?>images/admin/stats_icon_1.svg" alt="" class="stats__icon">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4  mb-4">
                    <div class="box box--white box--stats d-block">
                        <div class="box__body">
                            <img src="<?php echo CONF_WEBROOT_FRONT_URL; ?>images/admin/stats_icon_1.svg" alt="" class="stats__icon">
                            <h6 class="-txt-uppercase">
                                <?php echo Labels::getLabel('LBL_Order_Rentals', $adminLangId); ?>
                            </h6>
                            <h3 class="counter" data-currency="1" data-count="<?php echo $dashboardInfo["stats"]["totalRental"][4]["totalsales"]; ?>">0</h3>
                            <p>
                                <?php echo Labels::getLabel('LBL_This_Month', $adminLangId); ?>- <strong>
                                    <?php echo CommonHelper::displayMoneyFormat($dashboardInfo["stats"]["totalRental"][2]["totalsales"]); ?></strong></p>
                            <?php if ($objPrivilege->canViewOrders(AdminAuthentication::getLoggedAdminId(), true)) { ?>
                ...
                <div class="col-lg-4 col-md-4 col-sm-4  mb-4">
                    <div class="box box--white box--stats d-block">
                        <div class="box__body">
                            <img src="<?php echo CONF_WEBROOT_FRONT_URL; ?>images/admin/stats_icon_2.svg" alt="" class="stats__icon">
                            <h6 class="-txt-uppercase">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4  mb-4">
                    <div class="box box--white box--stats d-block">
                        <div class="box__body">
                            ...
                            <h3 class="counter" data-currency="1" data-count="<?php echo $dashboardInfo["stats"]["totalRental"][4]["totalcommission"]; ?>">0</h3>
                            <p>
                                <?php echo Labels::getLabel('LBL_This_Month', $adminLangId); ?>- <strong>
                                    <?php echo CommonHelper::displayMoneyFormat($dashboardInfo["stats"]["totalRental"][2]["totalcommission"]) ?></span></strong></p>
                            <?php if ($objPrivilege->canViewSalesReport(AdminAuthentication::getLoggedAdminId(), true)) { ?>
                ...
                <div class="col-lg-4 col-md-4 col-sm-4  mb-4">
                    <div class="box box--white box--stats d-block">
                        <div class="box__body">
                            <img src="<?php echo CONF_WEBROOT_FRONT_URL; ?>images/admin/stats_icon_3.svg" alt="" class="stats__icon">
                            <h6 class="-txt-uppercase">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4  mb-4">
                    <div class="box box--white box--stats d-block">
                        <div class="box__body">
                            <img src="<?php echo CONF_WEBROOT_FRONT_URL; ?>images/admin/stats_icon_4.svg" alt="" class="stats__icon">
                            <h6 class="-txt-uppercase">
                            ...
                            <div class="tabs_nav_container">
                                ...
                                <div class="tabs_panel_wrap">
                                    ...
                                    <div id="tabs_7" class="tabs_panel" style="width:100%;height:100%">
                                        <div id="monthly-rental-earnings--js" class="ct-chart ct-perfect-fourth graph--sales"></div>
                                    </div>
                                    <!-- ] -->
            ...
            <ul class="caraousel carousel--oneforth carousel--oneforth-js">
                <li>
                    <div class="carousel__item">
                        <div class="box box--social box--social-fb">
                            <img src="<?php echo CONF_WEBROOT_FRONT_URL; ?>images/admin/social_1.svg" alt="" class="box__icon">
                            <h3>
                ...
                <li>
                    <div class="carousel__item">
                        <div class="box box--social box--social-tw">
                            <img src="<?php echo CONF_WEBROOT_FRONT_URL; ?>images/admin/social_4.svg" alt="" class="box__icon">
                            <h3>
                ...
                <li>
                    <div class="carousel__item">
                        <div class="box box--social box--social-li">
                            <img src="<?php echo CONF_WEBROOT_FRONT_URL; ?>images/admin/social_2.svg" alt="" class="box__icon">
                            <h3>
                ...
                <li>
                    <?php /* <div class="carousel__item">
                        <div class="box box--social box--social-gp">
                            <img src="<?php echo CONF_WEBROOT_FRONT_URL; ?>images/admin/social_3.svg" alt="" class="box__icon">
                            <h3>
                    ...
                    <div class="carousel__item">
                        <div class="box box--social box--social-gp">
                            <img src="<?php echo CONF_WEBROOT_FRONT_URL; ?>images/admin/social_6.svg" alt="" class="box__icon">
                            <h3>
                                <?php echo isset($dashboardInfo['socialVisits']['rows']['Instagram']['%age']) ? $dashboardInfo['socialVisits']['rows']['Instagram']['%age'] : 0; ?>%</h3>
                            <p>
                ...
                <div class="col-sm-12">
                    <div class="tabs_nav_container responsive boxbased">
                        <ul class="tabs_nav">
                            ...
                            <?php /* <li><a rel="tabs_06" href="javascript:void(0)" onClick="searchStatistics('affiliates', this)"><i class="icon ion-android-contact"></i>
                                    <?php echo Labels::getLabel("LBL_Affiliate_Signups", $adminLangId); ?></a></li> */ ?>
                        </ul>
