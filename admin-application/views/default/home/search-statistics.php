            ...
            <tbody>
                ...
                if ($dashboardInfo["stats"]["totalOrders"] !== false):
                    ...
                    <tr>
                        ...
                        <td><?php echo CommonHelper::displayMoneyFormat($dashboardInfo["stats"]["totalRental"][0]["totalsales"]) ?></td>
                        <td><?php echo CommonHelper::displayMoneyFormat($dashboardInfo["stats"]["totalRental"][1]["totalsales"]) ?></td>
                        <td><?php echo CommonHelper::displayMoneyFormat($dashboardInfo["stats"]["totalRental"][2]["totalsales"]) ?></td>
                        <td><?php echo CommonHelper::displayMoneyFormat($dashboardInfo["stats"]["totalRental"][3]["totalsales"]) ?></td>
                        <td><?php echo CommonHelper::displayMoneyFormat($dashboardInfo["stats"]["totalRental"][4]["totalsales"]) ?></td>
                    </tr>

                    <tr>
                        <th><?php echo Labels::getLabel("LBL_Rental_Earnings", $adminLangId); ?></th>
                        <td><?php echo CommonHelper::displayMoneyFormat($dashboardInfo["stats"]["totalRental"][0]["totalcommission"]) ?></td>
                        <td><?php echo CommonHelper::displayMoneyFormat($dashboardInfo["stats"]["totalRental"][1]["totalcommission"]) ?></td>
                        <td><?php echo CommonHelper::displayMoneyFormat($dashboardInfo["stats"]["totalRental"][2]["totalcommission"]) ?></td>
                        <td><?php echo CommonHelper::displayMoneyFormat($dashboardInfo["stats"]["totalRental"][3]["totalcommission"]) ?></td>
                        <td><?php echo CommonHelper::displayMoneyFormat($dashboardInfo["stats"]["totalRental"][4]["totalcommission"]) ?></td>
                    </tr>
    ...
    case 'sellerproducts':
        ...
        <table class="table table-striped">
            ...
            <tbody>											
                <?php
                $counter = 0;
                foreach ($dashboardInfo['sellerProductsList'] as $sp) {
                    $counter++;
                    ?>
                    <tr>
    ...
    case 'shops':
        ...
        <table class="table table-striped">
            ...
            <tbody>
                <?php
                $shopCounter = 0;
                foreach ($dashboardInfo['shopsList'] as $shop) {
                    $shopCounter++;
                    ?>
                    <tr>
