...
class AffiliatesReportController extends AdminBaseController
{
    ...
    public function search($type = false)
    {
        ...
        if ($type == 'export') {
            ...
            $sheetData = array();
            $arr = array(Labels::getLabel('LBL_Name', $this->adminLangId), Labels::getLabel('LBL_Email', $this->adminLangId), Labels::getLabel('LBL_REG._DATE', $this->adminLangId), Labels::getLabel('LBL_Balance', $this->adminLangId), Labels::getLabel('LBL_Revenue', $this->adminLangId), Labels::getLabel('LBL_SignUp_Revenue', $this->adminLangId), Labels::getLabel('LBL_Order_Revenue', $this->adminLangId) );
