    ...
    public function search()
    {
        ...
        $srch->addMultipleFields(
                array('orrequest_id', 'orrequest_qty', 'orrequest_type', 'orrequest_returnreason_id',
                    ...
                    'IFNULL(op_product_name, op_product_identifier) as op_product_name', 'IFNULL(op_selprod_title, op_product_identifier) as op_selprod_title', 'op_selprod_options', 'op_brand_name', 'op_shop_name', 'op_qty', 'op_unit_price', 'order_tax_charged', 'op_other_charges', 'op_refund_shipping', 'op_invoice_number')
        );
