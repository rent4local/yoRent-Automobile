...
<div class="filters_body" id="filters_body--js">
    ...
    if (ALLOW_RENT > 0) {
        $productTypeArr[applicationConstants::PRODUCT_FOR_RENT] = Labels::getLabel('LBL_For_Rent', $siteLangId);
    }
    if (ALLOW_SALE > 0) {
        $productTypeArr[applicationConstants::PRODUCT_FOR_SALE] = Labels::getLabel('LBL_For_Sale', $siteLangId);
    }
    ...
    <?php } else { ?>
        <input name="producttype" data-id="producttype_2" value="2" data-title="<?php echo Labels::getLabel('LBL_For_Rent', $siteLangId); ?>" type="hidden">
    <?php } ?>
    <!-- ] -->
    <!-- ] -->
                            ...
                            <li>
                                <label class="checkbox brand" id="brand_<?php echo $brand['brand_id']; ?>">
                                    ...
                                    <input name="brands" data-id="brand_<?php echo $brand['brand_id']; ?>"
                                           ...
                                           <?php echo (in_array($brand['brand_id'], $brandsCheckedArr)) ? "checked" : ""; ?>>
                                </label>
                            </li>
                            <?php
                        }
                ...
                <?php if (count($brandsArr) >= 10) { ?>
                    <div class="link--more">
                        <a href="javascript:void(0)"
                           onClick="brandFilters()"><?php echo Labels::getLabel('LBL_View_More', $siteLangId); ?> </a>
                    </div>
                <?php } ?>
            </div>
        </div>
                    ...
                    <div class="sidebar-widget">
                        ...
                        <div class="sidebar-widget__body collapse show" id="availability">
                            <div class="toggle-target">
                                <ul class="list-vertical listing--vertical-check">
                                    <li>
                                    ...
                                    <div class="toggle-target">
                                        <ul class="list-vertical listing--vertical-chcek">
                                            ...
                                            foreach ($attrOpts as $key => $attrOpt) {
                                                ...
                                                ?>
                                                <li>
                                                    <label class="checkbox" id="<?php echo $attrId; ?>" data-groupname="<?php echo $attr['attr_name']; ?>">
