    ...
    <?php foreach ($reviewsList as $review) { ?>
        <div class="review-block">
            ...
            <p class="review-comment">
                <span class='lessText'><?php echo CommonHelper::truncateCharacters($review['spreview_description'], 300, '', '', true); ?><br>
                </span>
                <?php if (strlen($review['spreview_description']) > 300) { ?>
                    <span class='moreText hidden'><?php echo nl2br($review['spreview_description']); ?></span>
                    <a class="readMore link-plus" href="javascript:void(0);"><?php echo Labels::getLabel('Lbl_READ_MORE', $siteLangId); ?></a>
                <?php } ?>
            </p>
