                            ...
                            <li>
                                <a href="javascript:void(0)" class="header__user sign-in sign-in-popup-js header__user">
                                    <i class="icn icn-signin">
                                        <svg class="svg">
                                            <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/fashion/retina/sprite-header.svg#sign_in">
                                            </use>
                                        </svg>
                                    </i>
                ...
                <div class="row">
                    <div class="col">
                        <div class="short-nav" id="short-nav" data-close-on-click-outside="short-nav">
                            <?php
                            if (empty($sellerNavigationLeft)) {
                                $sellerNavigationLeft = [];
                            }
                            $this->includeTemplate('_partial/seller/sellerNavigationLeft.php', array('seller_navigation_left' => $sellerNavigationLeft)); ?>
                        </div>
                    </div>
