...
<form action="https://secure.payco.co/splitpayments.php" target="_blank" method="post"> 
   ...
   <input name="p_url_response" type="hidden" value="http://yorent.local.4livedemo.com/epay/response"> 
   <input name="p_url_confirmation" type="hidden" value="http://yorent.local.4livedemo.com/epay/confirm"> 
