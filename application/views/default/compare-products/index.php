        ...
        <div class="container">
            <div class="cd-products-comparison-table">
                <div class="cd-products-comparison-table-head">
                    <!-- <h2 class="title"><?php echo Labels::getLabel('LBL_Compare_Models', $siteLangId); ?></h2>
                    <div class="actions">
                        <a href="#0" class="reset"><?php echo Labels::getLabel('LBL_Reset', $siteLangId); ?></a>
                        <a href="#0" class=" filter"><?php echo Labels::getLabel('LBL_Filter', $siteLangId); ?></a>
                    </div> -->
                    ...
                    <div class="clipboard">
                        ...
                        <a class="clipboard_btn" onclick="copyContent()" href="javascript:void(0)"><i
                    ...
                    <div class="cd-products-wrapper scroll scroll-y">
                        <ul class="cd-products-columns level-1--js">
                            ...
                            <li class="product level-2--js">
                                <div class="top-info">
                                    <div class="close-layer close-layer-lg"
                                        onclick="removeFromCompareList('<?php echo $selProd; ?>', 1,<?php echo $isUrlCompare;?>)">
                                    </div>

                                    <div class="prod"
                                        href="<?php echo CommonHelper::generateUrl('Products', 'View', array($selProd)); ?>"
                                        tabindex="0">
                                        <img class="prod-img"
                                    ...
                                    <h3>
                                        <a href="<?php echo CommonHelper::generateUrl('Products', 'View', array($productsDetail[$selProd]['selprod_id'])); ?>"
                                            tabindex="0"><?php echo substr($productsDetail[$selProd]['selprod_title'], 0, 50) . '...'; ?></a>
                                    ...
                                    <div class="action <?php echo ($cartType == applicationConstants::PRODUCT_FOR_SALE) ? "disabled" : ""; ?>">
                                        ...
                                        <i class="icn sale-rent-only" data-toggle="tooltip" data-placement="top"
                                ...
                                <ul class="cd-features-list">
                                    ...
                                    <li><a href="<?php echo CommonHelper::generateUrl('brands', 'View', array($productsDetail[$selProd]['brand_id'])); ?>"
                                    ...
                                    <?php if (FatApp::getConfig("CONF_ALLOW_REVIEWS", FatUtility::VAR_INT, 0)) { ?>
                                    <li>
                                        <?php $catRating = $catalogRating = (!empty($catalogReviewsArr[$prod]['prod_rating'])) ? round($catalogReviewsArr[$prod]['prod_rating'], 1) : 0;
                                    ...
                                    <li><?php echo $productsDetail[$selProd]['user_name'];
                                            if (!empty($productsDetail[$selProd]['user_phone'])) {
                                                echo "</br>" . $productsDetail[$selProd]['user_phone'];
                                            }
                                    ...
                                    <?php if (!empty($attributesArray)) { ?>
                                    <?php foreach ($attributesArray[$selProd] as $key => $value) {
                                                if (is_array($value)) {
                                            ?>
                                    <li> <?php foreach ($value as $val) {
                                                                echo $val . '<br>';
                                                            } ?></li>
                                    <?php } else { ?>
                                    ...
                                    <div class='moreseller'>
                                        <a class="moreseller_img"
                                            href="<?php echo CommonHelper::generateUrl('shops', 'view', array($value['shop_id'])); ?>">
                                            <img
                                                src="<?php echo CommonHelper::generateUrl('image', 'shopLogo', array($value['shop_id'], $siteLangId, 'SMALL')); ?>"></a>
                                        <div class="moreseller_detail">
                                            ...
                                            <div class="moreseller_action">
                                                ...
                                                <a href="javascript:void(0)" class="link"
                                                    onclick="quickDetail('<?php echo $key; ?>')"><?php echo Labels::getLabel('LBL_Rent_Now', $siteLangId); ?></a>
                                                <?php } ?>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <li>
                                        <?php if (!empty($prodReviewArr[$prod])) {
                                                ...
                                                ?>
                                        <div class="compare-reviews" <?php if ($reviewKey > 0) {
                                                                                            echo 'class="mt-5"';
                                                                                        } ?>>
                            ...
                            <li class="product level-2--js">
                                <div class="top-info add-compare-field">
                                    <input class="form-control search-magni"
                                        placeholder="<?php echo Labels::getLabel('LBL_Add_new_product', $siteLangId); ?>"
                                        type="text" name="search_product" id="search_product_js" />
