            ...
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-xl-2 mt-3 mt-xl-0">
                   <div class="btn-groups">
                    <a href="<?php echo CommonHelper::generateFullUrl('CompareProducts', 'index'); ?>" onclick="add_to_compare()" class="btn btn-brand "><?php echo Labels::getLabel('LBL_Compare', $siteLangId); ?>&nbsp
