            ...
            <div class="row">
                ...
                <div class="col-auto">
                    <div class="no-print">
                        ...
                        <a href="javascript:void(0)" onclick='generateLabel(<?php echo $opId; ?>)'
                            class="btn btn-outline-brand btn-sm no-print"
                            title="<?php echo Labels::getLabel('LBL_GENERATE_LABEL', $siteLangId); ?>"><?php echo Labels::getLabel('LBL_GENERATE_LABEL', $siteLangId); ?></a>
                        ...
                        <a target="_blank"
                            ...
                            class="btn btn-outline-brand btn-sm no-print"
                            title="<?php echo Labels::getLabel('LBL_PREVIEW_LABEL', $siteLangId); ?>"><?php echo Labels::getLabel('LBL_PREVIEW_LABEL', $siteLangId); ?></a>
                        <?php }
                        if ((!empty($orderStatus) && 'awaiting_shipment' == $orderStatus && !empty($orderDetail['opship_response']) || 'EasyPost' == $keyName) && empty($orderDetail['opship_tracking_number'])) {
                            ...
                            ?>
                        <a href="javascript:void(0)" onclick="proceedToShipment(<?php echo $orderDetail['op_id']; ?>)"
                            class="btn btn-outline-brand btn-sm no-print"
