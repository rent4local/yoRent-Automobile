            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">    
                    <div class="cg-nav-wrapper cg--js">
                        <?php
                        $featuredCategory = array_slice($categoriesArr, 0, 1000);
                        $chunkedCategories = array_chunk($featuredCategory, 4, 1);
                        $embedMoreCat = false;
                        if (count($categoriesArr) > 1000)
                            $embedMoreCat = true;
                        $catCount = 1;
                                ...
                                if ($embedMoreCat && $catCount == 1001) {
                                    ...
                                    <li class="">
                                        <a class="anchor--js" data-role="anchor--js--link-<?php echo $catCount; ?>" href="javascript:void(0)"> 
                                            ...
                                            </i> <span class="caption"><?php echo Labels::getLabel('LBL_More_Categories', $siteLangId); ?></span> 
                                        </a>
                                    </li>
                                    <?php
                                }
                    ...
                    <span class="gap"></span>
                    <?php $this->includeTemplate('category/categories-list.php', array('categoriesArr' => $categoriesArr, 'siteLangId' => $siteLangId), false); ?>
                </div>
            </div>
        </div>
    </section>
