                                            ...
                                            <li>
                                                <div class="items-group">
                                                    <div class="item item--small item--hovered <?php echo(!$product['in_stock']) ? 'item--sold' : ''; ?>">
                                                        <?php
                                                        if ((ALLOW_SALE && $product['is_sell'] && $product['selprod_stock'] <= 0) && (ALLOW_RENT && $product['is_rent'] && $product['sprodata_rental_stock'] <= 0)) {
                                                            $batchInStock = false;
                                                            ?>
                                    ...
                                    <div class="items-group">
                                        <div class="item__total">
                                            ...
                                            <?php if ($batchInStock) { ?>
                                                ...
                                                <a href="javascript:void(0)" onclick="cart.addGroup('<?php echo $batch['prodgroup_id']; ?>');" class="btn btn-brand btn--h-large"><?php echo Labels::getLabel('LBL_Add_to_Cart', $siteLangId); ?></a>
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
