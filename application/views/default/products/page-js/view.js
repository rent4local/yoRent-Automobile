...
$(document).ready(function () {
    $('.with-arrow-slider-js').slick({
        dots: false,
        arrows: true,
        appendArrows: '.related_prod .slide-arrow',
        prevArrow: $('.related_prod .arrow-prev'),
        nextArrow: $('.related_prod .arrow-next'),
        infinite: false,
        speed: 300,
        slidesToShow: 4,
        slidesToScroll: 1,
    ...
    $('.recommended-prod-with-arrow-slider-js').slick({
        dots: false,
        arrows: true,
        appendArrows: '.recommended-prod .slide-arrow',
        prevArrow: $('.recommended-prod .arrow-prev'),
        nextArrow: $('.recommended-prod .arrow-next'),
        infinite: false,
        speed: 300,
        slidesToShow: 4,
        slidesToScroll: 1,
