...
<div class="modal-body bg-modal">
	...
	<div class="row get-started-wrapper">
		<div class="col-md-6 text-center cms">
			...
			<p>I Really Liked The Features Of Yo!Rent And Want To Discuss My Project</p>
			<a href="https://www.yo-rent.com/contact-us.html" target="_blank" class="btn btn-outline-brand btn-sm">Get Started</a>
		</div>
		<div class="col-md-6 text-center cms">
			...
			<a href="https://www.yo-rent.com/?q=demo-popup" target="_blank" class="btn btn-outline-brand btn-sm">Book A Free Demo</a>
		</div>
	</div>
