...
<section class="is-completed">
    <div class="selected-panel">
        ...
        <div class="selected-panel-action"><a href="javascript:void(0);" onclick="viewOrder()" ;
                class="btn btn-brand btn-sm ripplelink"><?php echo Labels::getLabel('LBL_View_Order', $siteLangId); ?></a>
        </div>
    </div>
</section>