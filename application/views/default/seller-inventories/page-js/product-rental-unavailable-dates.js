...
(function () {
    searchUnavailbleDates = function (frm) {
        ...
        fcom.ajax(fcom.makeUrl('SellerInventories', 'searchUnavailbleDates'), data, function (res) {
            $("#listing").html(res);
        });
    };
    ...
    clearSearch = function (selProd_id) {
        if (0 < selProd_id) {
            location.href = fcom.makeUrl('SellerInventories', 'searchUnavailbleDates');
        } else {
    ...
    productRentalUnavailableDatesForm = function (selprod_id = 0, pu_id = 0) {
        ...
        fcom.ajax(fcom.makeUrl('SellerInventories', 'productRentalUnavailableDatesForm', [selprod_id, pu_id]), '', function (t) {
    ...
    setUpRentalUnavailableDates = function (frm) {
        ...
        fcom.updateWithAjax(fcom.makeUrl('SellerInventories', 'setUpRentalUnavailableDates'), data, function (t) {
            productRentalUnavailableDatesForm();
    ...
    deleteRentalUnavailableDates = function (selprodId, pu_id) {
        ...
        fcom.updateWithAjax(fcom.makeUrl('SellerInventories', 'deleteRentalUnavailableDates'), 'selprodId=' + selprodId + '&pu_id=' + pu_id, function (t) {
            searchUnavailbleDates();
        });
    };
    ...
    sellerProductDurationDiscountForm = function (selprod_id = 0, durdiscount_id = 0) {
        ...
        fcom.ajax(fcom.makeUrl('SellerInventories', 'sellerProductDurationDiscountForm', [selprod_id, durdiscount_id]), '', function (t) {
    ...
    setUpSellerProductDurationDiscount = function (frm) {
        if (!$(frm).validate())
            return;
        var data = fcom.frmData(frm);
        fcom.updateWithAjax(fcom.makeUrl('SellerInventories', 'setUpSellerProductDurationDiscount'), data, function (t) {
    ...
    deleteSellerProductDurationDiscount = function (produr_id) {
        ...
        fcom.updateWithAjax(fcom.makeUrl('SellerInventories', 'deleteSellerProductDurationDiscount'), 'produr_id=' + produr_id, function (t) {
            searchUnavailbleDates();
        });
    };
