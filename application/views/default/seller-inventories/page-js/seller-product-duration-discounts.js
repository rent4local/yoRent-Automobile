...
(function () {
    ...
    searchDurationDiscounts = function (frm) {
        ...
        fcom.ajax(fcom.makeUrl('SellerInventories', 'searchDurationDiscounts'), data, function (res) {
            $("#listing").html(res);
        });
    };
    clearSearch = function (selProd_id) {
        if (0 < selProd_id) {
            location.href = fcom.makeUrl('SellerInventories', 'searchDurationDiscounts');
        } else {
