    ...
    <div class="content-wrapper content-space">
        <div class="content-header row">
            <div class="col">
                ...
                <h2 class="content-header-title"><?php echo Labels::getLabel('LBL_Seller_Products_Duration_Discounts', $siteLangId); ?><i class="fa fa-info-circle" data-toggle="tooltip" data-placement="right" title="<?php echo Labels::getLabel('LBL_Add_discount_if_a_buyer_has_rented_an_item_for_more_than_specified_duration.', $siteLangId); ?>"></i></h2>
