		...
		<div class="row ">
			<div class="col-md-12">
				...
				<div class="">
					...
					<img src="<?php echo UrlHelper::generateUrl('Category','sellerBanner',array($img['afile_record_id'],$img['afile_record_subid'],$img['afile_lang_id'],'WIDE'));?>" alt="<?php echo Labels::getLabel('LBL_Shop_Banner',$siteLangId);?>">
