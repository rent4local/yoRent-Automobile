  ...
  <div class="">
    <div class="product-options">
      ...
      <ul>
        ...
        <li  data-heading="OR" ><a href="<?php echo UrlHelper::generateUrl('seller','customProductForm' );?>"><i class="icn fa  fa-camera"></i>
        ...
        <?php } ?>
        <li  data-heading="OR"><a href="<?php echo UrlHelper::generateUrl('seller','catalog',array(1));?>"><i class="icn fa fa-camera-retro"></i>
        ...
        <li  data-heading="OR"><a href="<?php echo UrlHelper::generateUrl('ImportExport','index'); ?>"><i class="far fa-file-alt"></i>
