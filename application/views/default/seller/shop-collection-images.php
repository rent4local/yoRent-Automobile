...
<div class="col-md-12">
    <div class="profile__pic">
        <img src="<?php echo CommonHelper::generateUrl('image', 'shopCollectionImage', array($images['afile_record_id'], $images['afile_lang_id'], 'THUMB')).'&t='. time();?>" alt="<?php echo Labels::getLabel('LBL_Collection_Image', $siteLangId);?>">
    </div>
