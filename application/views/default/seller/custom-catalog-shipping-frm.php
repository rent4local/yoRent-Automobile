...
if (!FatApp::getConfig('CONF_SHIPPED_BY_ADMIN_ONLY', FatUtility::VAR_INT, 0) && FatApp::getConfig("CONF_PRODUCT_DIMENSIONS_ENABLE", FatUtility::VAR_INT, 0)) {
...
$btnSubmitFld->setWrapperAttribute('class', 'text-right custom-btn--js');
...
<script type="text/javascript">
    $(document).ready(function () {
        var btnHtml = $('.custom-btn--js .field-set').html();
        $('.custom-btn--js .field-set').remove();
        $('.custom-btn--js').prepend('<div class="btn-group"><div class="col-auto js-approval-btn"></div>' + btnHtml + '</div>');
    });
</script>