    ...
    <div class="p-4 mb-4 bg-gray rounded" dir="<?php echo $layout; ?>">
        <div class="row">
                ...
                <div class="field-set">
                    ...
                    <div class="field-wraper">
                        <div class="field_cover">
                            <input class="specification-field-js" type="text"
                                name="prodspec_name[<?php echo $langId; ?>]"
                                value="<?php echo (!empty($prodSpecData) && isset($prodSpecData['prod_spec_name'][$langId])) ? $prodSpecData['prod_spec_name'][$langId] : ""; ?>">
                            <ul style="display:none;" class="errorlist erlist_specification_<?php echo $langId; ?>">
                                <li><a
                                        href="javascript:void(0);"><?php echo Labels::getLabel('LBL_Specification_Label_Text_Is_Mandatory', $siteLangId); ?></a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="col-md-3">
                ...
                <div class="field-wraper">
                    <div class="field_cover">
                        <span class="filename"></span><input id="prodspec_files_<?php echo $langId; ?>" type="file"
                            name="prodspec_files_<?php echo $langId; ?>" data-langid="<?php echo $langId; ?>"
                            onChange="popupSpecificationFile(<?php echo $langId; ?>);">
                        <ul style="display:none;" class="errorlist erlist_specification_media<?php echo $langId; ?>">
                            <li><a
                                    href="javascript:void(0);"><?php echo Labels::getLabel('LBL_Specification_File_Is_Mandatory', $siteLangId); ?></a>
                            </li>
                        </ul>
                        <br>
                    </div>
        ...
        <div class="field-wraper">
            <div class="field_cover">
                <input type="text" class="prodspec_group specification-field-js" name="prodspec_group"
                    value="<?php echo (!empty($prodSpecData) && isset($prodSpecData['prod_spec_group'][$langId])) ? $prodSpecData['prod_spec_group'][$langId] : ""; ?>">
            </div>
        </div>
    </div>
    </div> */ ?>
                ...
                <div class="field_cover">
                    <label class="checkbox">
                        <input title="<?php echo Labels::getLabel('LBL_Translate_To_Other_Languages', $siteLangId); ?>"
                            type="checkbox" name="autocomplete_lang_data" value="1">
    ...
    <div class="col-md-12">
        ...
        <div class="accordion my-4" id="specification-accordion-<?php echo $otherLangId; ?>">
            <h6 class="dropdown-toggle toggle-other-lang-data" data-toggle="collapse"
                ...
                onClick="displayOtherLangProdSpec(this,<?php echo $otherLangId; ?>, '<?php echo $langId; ?>')">
                <span>
                    <?php
                                    echo $data . " ";
                ...
                <div class="specifications-form-<?php echo $otherLangId; ?>">
                    <div class="row">
                        <div class="col-md-9">
                            <div class="field-set">
                                ...
                                <div class="field-wraper">
                                    <div class="field_cover">
                                        <input class="specification-field-js" type="text"
                                            name="prodspec_name[<?php echo $otherLangId; ?>]"
                                            value="<?php echo (!empty($prodSpecData) && isset($prodSpecData['prod_spec_name'][$otherLangId])) ? $prodSpecData['prod_spec_name'][$otherLangId] : ""; ?>">
                                        <ul style="display:none;"
                                            class="errorlist erlist_specification_<?php echo $otherLangId; ?>">
                                            <li><a
                                                    href="javascript:void(0);"><?php echo Labels::getLabel('LBL_Specification_Label_Text_Is_Mandatory', $siteLangId); ?></a>
                                            </li>
                                        </ul>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="field-wraper">
                                <div class="field_cover">
                                    <span class="filename"></span><input id="prodspec_files_<?php echo $otherLangId; ?>"
                                        type="file" name="prodspec_files_<?php echo $otherLangId; ?>"
                                        data-langid="<?php echo $otherLangId; ?>"
                                        onChange="popupSpecificationFile(<?php echo $otherLangId; ?>);">
                                    <ul style="display:none;"
        ...
        <div class="field-set">
            ...
            <div class="field-wraper">
                <div class="field_cover">
                    ...
                    <input type="hidden" name="prod_spec_file_index"
                        value="<?php echo (!empty($prodSpecData) && isset($prodSpecData['prod_spec_file_index'][$langId]) && $prodSpecData['prod_spec_file_index'][$langId] != '') ? $prodSpecData['prod_spec_file_index'][$langId] : rand(10, 99999); ?>">
                    <input type="hidden" name="langId" value="<?php echo $langId; ?>">
                    <input type="hidden" name="preq_id" value="<?php echo $preqId; ?>">
                    <input type="hidden" name="key"
                        value="<?php echo (!empty($prodSpecData)) ? $prodSpecData['key'][$langId] : -1; ?>">
                    <button type="button" class="btn btn-outline-brand"
                        onClick="saveSpecificationWithFile()"><?php echo Labels::getLabel('LBL_Add_Specification', $siteLangId) ?></button>
                </div>
            </div>
        </div>
    </div>
