...
<div id="body" class="body">
	...
	$bgImageUrl = ($haveBgImage) ? "background-image:url(" . UrlHelper::generateUrl( 'Image', 'cblockBackgroundImage', array($slogan['epage_id'], $siteLangId, 'DEFAULT', AttachedFile::FILETYPE_ADVERTISER_PAGE_SLOGAN_BG_IMAGE) ) . ")" : "background-image:url(".CONF_WEBROOT_URL."images/seller-bg.png);"; ?>
