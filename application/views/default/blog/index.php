    ...
    <div class="container">
        <div class="section-head">
            <div class="section__heading">
                <h2><?php echo Labels::getLabel('LBL_Featured_Blogs', $siteLangId); ?>
                </h2>
            </div>
            <?php if (count($featuredPostList) > 4) { ?>
            <div class="section__action">
                <a class="arrows arrows--left">
                    <svg version="1.1" x="0px" y="0px" viewBox="0 0 31.494 31.494"
        ...
        c-0.444,0.444-1.143,0.444-1.587,0l-9.952-9.952c-0.429-0.429-0.429-1.143,0-1.571L10.273,5.009z" />
                ...
                <a class="arrows arrows--right"><svg x="0px" y="0px" viewBox="0 0 31.49 31.49"
                        style="enable-background:new 0 0 31.49 31.49;" xml:space="preserve" width="512px"
                        height="512px">
                        <path
...
<section class="section ">
    <div class="container">
        <div class="section-head">
            <div class="section__heading">
                <h2><?php echo Labels::getLabel('LBL_Popular_Blogs', $siteLangId); ?>
                </h2>
            </div>
            <div class="section__action">
                <a class="arrows arrows--left">
