<?php defined('SYSTEM_INIT') or die('Invalid Usage'); 
	...
	$frm->setFormTagAttribute('onSubmit', 'setupOrderMessage(this,"buyer"); return false;');
	...
	$toFldFieldWrapper->appendElement( 'div', array('class' => 'field_cover'), $data['op_shop_owner_name'].' (<em>'.$data['op_shop_name'].'</em>)', true );
...
<div class="modal-dialog modal-dialog-centered" role="document" id="send-order-message">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title"><?php echo Labels::getLabel('LBL_Send_Message_to_order_owner', $siteLangId); ?></h5>
