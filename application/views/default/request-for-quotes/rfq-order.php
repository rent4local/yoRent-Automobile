...
$orderTypeFld = $frmOrderSrch->getField('rent_or_sale');
$orderTypeFld->setWrapperAttribute('class', 'col-lg-3');
$orderTypeFld->developerTags['col'] = 3;
$orderTypeFld->developerTags['noCaptionTag'] = true;
    ...
    <div class="content-wrapper content-space">
        <div class="content-header row">
            <div class="col">
                ...
                <h2 class="content-header-title"><?php echo Labels::getLabel('LBL_RFQ_Orders', $siteLangId); ?></h2>
            </div>
        </div>
