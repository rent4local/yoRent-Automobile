...
$orderTypeFld->setWrapperAttribute('class', 'col-lg-4');
$orderTypeFld->developerTags['col'] = 4;
    ...
    <div class="content-wrapper content-space">
        <div class="content-header row">
            <div class="col">
                ...
                <h2 class="content-header-title"> <?php echo Labels::getLabel('RFQ_Orders', $siteLangId); ?></h2>
