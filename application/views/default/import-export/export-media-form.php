...
if ($actionType == Importexport::TYPE_ADDONS || $actionType == Importexport::TYPE_PRODUCTS || $actionType == Importexport::TYPE_SELLER_PRODUCTS || $actionType == Importexport::TYPE_INVENTORIES) {
