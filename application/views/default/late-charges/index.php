...
<main id="main-area" class="main"   >
    <div class="content-wrapper content-space">
        <div class="content-header row ">
            <div class="col">
                <h2 class="content-header-title"><?php echo Labels::getLabel('LBL_Late_Charges_Profile', $siteLangId); ?>
                <i class="fa fa-info-circle" data-toggle="tooltip" data-placement="right" title="<?php echo Labels::getLabel('LBL_Create_late_charges_profile_by_setting_up_amount_for_late_charges_and_link_products_to_the_profile.', $siteLangId); ?>"></i></h2>
            </div>
            <?php if ($canEdit) { ?>
                <div class="col-auto">
                    <div class="content-header-right">
                        <a href="<?php echo UrlHelper::generateUrl('lateCharges', 'form', [0]); ?>" class="btn btn-outline-brand btn-sm"><?php echo Labels::getLabel('LBL_Create_Profile', $siteLangId); ?></a>
                    </div>
                </div>
            <?php } ?>
        </div>
