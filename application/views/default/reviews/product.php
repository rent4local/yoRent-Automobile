    ...
    <div class="bg-second pt-3 pb-3">
        <div class="container ">
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-md-auto col-sm-auto mt-3 mt-md-0">
                    <a href="<?php echo UrlHelper::generateUrl('Products', 'view', array($product['selprod_id'])); ?>"
                        class="btn btn-outline-white btn-sm"><?php echo Labels::getLabel('Lbl_Back_to_Product', $siteLangId); ?></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <section class="section">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-7">
                    <div id="itemRatings">
                        <div class="section__head review-list-head">
                            <h4><?php echo Labels::getLabel('Lbl_Reviews_of', $siteLangId) . ' ' . (($product['selprod_title']) ? $product['selprod_title'] . ' - ' . $product['product_name'] : $product['product_name']); ?>
                            </h4>
