...
if(!empty($friendList)){ ?>
	<div class="btn-group">
		<a href="javascript:void(0);" onclick="shareAndEarn(<?php echo $selprod_id;?>);" class="btn btn-outline-brand btn-sm"><?php echo Labels::getLabel("LBL_Share_and_Earn", $siteLangId)?></a>
	</div>
<?php	$arr_flds = array(
