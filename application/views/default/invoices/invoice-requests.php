...
$frmSearch->setFormTagAttribute('id', 'frmSearchRequests');
$frmSearch->setFormTagAttribute('onsubmit', 'searchRequests(this); return(false);');
    ...
    <div class="content-wrapper content-space">
        <div class="content-header row">
            <div class="col">
                ...
                <h2 class="content-header-title"><?php echo Labels::getLabel('LBL_My_RFQ_(_Invoice_Regenerate_Requests_)', $siteLangId); ?></h2>
            </div>
        </div>
