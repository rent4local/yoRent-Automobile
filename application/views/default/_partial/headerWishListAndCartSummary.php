...
<div class="side-cart" id="side-cart" data-close-on-click-outside-cart="side-cart">
    ...
    <div class="side-cart_foot">
        ...
        <div class="buttons-group">
            <a href="javascript:void(0);" onclick="cart.clear();"
                class="btn btn-outline-brand"><?php echo Labels::getLabel('LBL_CLEAR_CART', $siteLangId); ?> </a>
            <a class="btn btn-brand"
                href="<?php echo UrlHelper::generateUrl('cart'); ?>"><?php echo Labels::getLabel('LBL_Go_To_Cart', $siteLangId); ?></a>
...
<?php /* <a href="javascript:void(0)" data-trigger-cart="side-cart">
      <span class="icn">
      <svg class="svg">
      <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite.svg#main-cart"
href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite.svg#main-cart"></use>
</svg></span>
<span
    class="cartQuantity"><?php echo (Cart::CART_MAX_DISPLAY_QTY < $totalCartItems) ? Cart::CART_MAX_DISPLAY_QTY . '+' : $totalCartItems; ?></span>
