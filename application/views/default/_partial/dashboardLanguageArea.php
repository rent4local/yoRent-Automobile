...
<?php if (($languages && count($languages) > 1) || ($currencies && count($currencies) > 1)) { ?>
    ...
    <li class="menu__item">
        ...
        <a href="" class="accordianheader">
            <i class="icn "><svg class="svg">
                    <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/dashboard/retina/sidebar.svg#language"></use>
                </svg>
    ...
    <li class="menu__item">
        <div class="menu__item__inner"><a title="" href=""  class="accordianheader">
            <i class="icn "><svg class="svg">
                    <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/dashboard/retina/sidebar.svg#currency"></use>
                </svg>
