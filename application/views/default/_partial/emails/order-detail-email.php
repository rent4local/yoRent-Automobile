	...
	<table width="100%">
		<tr>
			<td style="padding:15px 0;">
				<table width="100%">
					<tr>
						<td style="padding:15px 0;border-top:1px solid #ddd;border-bottom:1px solid #ddd;"> <strong><?php echo Labels::getLabel('Lbl_Order_No.', $siteLangId); ?>:</strong> <span style="font-size: 14px"><?php echo $orderInfo['order_id']; ?></span> </td>
						<td style="padding:15px 0;text-align:right;border-top:1px solid #ddd;border-bottom:1px solid #ddd;"> <strong><?php echo Labels::getLabel('Lbl_Order_Date', $siteLangId); ?></strong> <span style="font-size: 14px"><?php echo  FatDate::format($orderInfo['order_date_added']); ?></span> </td>
					</tr>
								...
								<tr>
									<td style="padding-bottom:10px">
										<table width="100%" cellspacing="0">
                                            ...
                                            $pickupAddressArr = array_filter(array_column($orderProductsData, 'pickupAddress'));
                                            foreach ($orderProductsData as $addrKey => $orderProducts) {
                                            if (!empty($orderProducts['pickupAddress'])) {
                                                $pickupAdd = $orderProducts['pickupAddress'];
                                            ...
                                            if (array_key_exists('opshipping_fulfillment_type', $val)) { 
                                                $prodOrBatchUrl = 'javascript:void(0)';
                                                $prodOrBatchImgUrl = UrlHelper::getCachedUrl(UrlHelper::generateFullFileUrl('image', 'product', array($val['selprod_product_id'], "SMALL", $val['op_selprod_id'], 0, $siteLangId), CONF_WEBROOT_URL), CONF_IMG_CACHE_TIME, '.jpg');
                                                ...
                                                $netAmount += CommonHelper::orderProductAmount($val, 'NETAMOUNT');
														...
														<table width="100%">
															<tr>
																<td style="color: #535b61;"> 
                                                                    ...
                                                                    <?php } ?>    
																	<p style="margin:0;margin-top:10px"><strong><?php echo Labels::getLabel('Lbl_Sold_By', $siteLangId); ?></strong> : <?php echo $val["op_shop_name"];?></p>
																</td>
																...
																<td colspan="2">
																	<table width="100%" style="border-top: 1px solid #ddd; margin-top: 10px; padding-top: 10px;color:#535b61;line-height:1.4;font-size:14px">
                                                                        ...
                                                                        foreach ($attachedAddon as $addon) {    
                                                                            ...
                                                                            $netAmount += CommonHelper::orderProductAmount($addon, 'NETAMOUNT');
                                                                        ?>
                                                                        <tr>
