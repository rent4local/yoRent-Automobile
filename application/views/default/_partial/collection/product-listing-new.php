    ...
    <div class="products__quickview">
        ...
        ?>
            <label><span class="checkbox">
                    <input onclick="compare_products(this,<?php echo $product['selprod_id']; ?>)" class="compare_product_js_<?php echo $product['selprod_id']; ?> comp_product_cat_<?php echo $product['prodcat_id'];?> compProductsJs" data-catid=<?php echo $product['prodcat_id'];?>  title="Compare Product" name="compare" value="1" type="checkbox" <?php if ($prodInCompList == 1) {
                                                                                                                                                                                                                                    echo 'checked="checked"';
                                                                                                                                                                                                                                } ?>>
                    </span><?php echo Labels::getLabel('LBL_Add_To_Compare', $siteLangId); ?>
            </label>
        <?php } ?>
    </div>
