<?php if (isset($collection['shops']) && count($collection['shops']) > 0) { ?>
    <section class="section collection-shop" id="shop_layout2_<?php echo $collection['collection_id']; ?>">
        <div class="container container--narrow">
			...
			<div class="row <?php echo (count($collection['shops'])) > 3 ? " js-carousel" : ""; ?> " data-slides="4,3,3,2,2" data-infinite="false" data-arrows="false" data-slickdots="true">
                                ...
                                <div class="shop__card--body">
                                    <div class="shop-media">
                                        <a href="<?php echo (!isset($shop['shopData']['promotion_id']) ? UrlHelper::generateUrl('shops', 'view', array($shop['shopData']['shop_id'])) : UrlHelper::generateUrl('shops', 'track', array($shop['shopData']['promotion_record_id'], Promotion::REDIRECT_SHOP, $shop['shopData']['promotion_record_id']))); ?>">
                                            ...
                                            <img alt="<?php echo $shop['shopData']['shop_name']; ?>" data-aspect-ratio="1:1" src="<?php echo UrlHelper::getCachedUrl(UrlHelper::generateFileUrl('image', 'shopLogo', array($shop['shopData']['shop_id'], $siteLangId, "SHOP_LAYOUT_2", 0, false), CONF_WEBROOT_URL), CONF_IMG_CACHE_TIME, '.jpg'); ?>">
                                            </picture>
                                        </a>
                                    </div>
                                </div>
                                    ...
                                    <div class="shop-description">
                                        ...
                                        <p class="shop-location">
                                            <i class="icn icn-coll-location">
                                                <svg class="svg">
                                                    <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/fashion/retina/sprite-front.svg#collection-location"></use>
                                                </svg>
                                            </i>
