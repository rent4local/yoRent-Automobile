...
<ul>
    ...
    <li class="<?php echo $action == 'collection' ? 'is--active' : '' ?>"><a href="<?php echo UrlHelper::generateUrl('shops', 'collections', array($shop_id));?>" class="ripplelink"><?php echo $collectionData['collectionName']; ?></a></li>
    <?php } */ ?>
