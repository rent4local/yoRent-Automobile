...
<div id="body" class="body template-<?php echo $template_id; ?>">
    ...
    $shopData = array_merge($data, array('template_id' => $template_id, 'collectionData' => $collectionData, 'action' => $action, 'shopTotalReviews' => $shopTotalReviews, 'shopRating' => $shopRating, 'socialPlatforms' => $socialPlatforms, 'userParentId' => $userParentId,'pageSize'=>$data['pageSize']));
    $shopData['postedData']['pageSize'] = $data['pageSize'];
    
	$this->includeTemplate('shops/shop-header.php', $shopData, false);
    ?>
