...
<div class="bg-second pt-3 pb-3">
   <div class="container">
	   <div class="row">
		   ...
		   <div class="col-md-4 col-sm-4 align--right"><a href="<?php echo UrlHelper::generateUrl('Shops', 'View', array($shopData['shop_id'])); ?>" class="btn btn-outline-white btn-sm"><?php echo Labels::getLabel('LBL_Back_to_Shop', $siteLangId); ?></a>
