(function($){
	...
	$.extend($.mbsmessage, {
		settings:{
			leftimage:siteConstants.webroot + 'images/mbsmessage/left.png',
			rightimage:siteConstants.webroot + 'images/mbsmessage/right.png',
			mbshtml: '\
	...
	function initialize(settings){
		...
		preload[0].src= ($.mbsmessage.settings.closeimage != undefined) ? $.mbsmessage.settings.closeimage : siteConstants.webroot + 'images/mbsmessage/close.gif';
