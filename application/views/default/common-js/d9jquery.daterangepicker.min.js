        ...
        (U.fn.dateRangePicker = function (f) {
                        ...
                        (m = (function () {
                            ...
                            f.extraClass && (t += " " + f.extraClass + " "),
                                ...
                                f.showTopbar &&
                                    ...
                                    f.customTopBar
                                        ? ("function" == typeof f.customTopBar && (f.customTopBar = f.customTopBar()), (t += '<div class="custom-top">' + f.customTopBar + "</div>"))
                                    ...
                                    (t += '<input type="button" class="apply-btn disabled' + (!(e = "") === f.autoClose && (e += " hide"), "" !== f.applyBtnClass && (e += " " + f.applyBtnClass), e) + '" value="' + K("apply") + '" />'),
                                    (t += "</div>"));
                            ...
                            if (
                                ...
                                (t +=
                                    ...
                                    (f.singleDate || !f.stickyMonths ? '<span class="next">' + r + "</span>" : "") +
                    ...
                    setTimeout(function () {
                        ...
                        m.find("[shortcut]").on("click", function () {
                            ...
                            if (-1 != t.indexOf("day")) {
                                ...
                                (e = -1 != t.indexOf("prev,") ? -1 : 1), (n = new Date()).setFullYear(a.getFullYear() + e), n.setMonth(0), n.setDate(1), a.setFullYear(a.getFullYear() + e), a.setMonth(11), a.setDate(31);
                            else if ("custom" == t) {
                                var o = U(this).html();
            ...
            function i() {
                if (!f.inline) {
                    ...
                    if ("relative" == U(f.container).css("position")) {
                        ...
                        e.left < 460
                            ? m.css({ top: e.top + U(n).outerHeight() + parseInt(U("body").css("border-top") || 0, 10), left: e.left })
                            : m.css({ top: e.top + U(n).outerHeight() + parseInt(U("body").css("border-top") || 0, 10), left: e.left + U(n).width() - m.width() - 16 });
                }
            }
            function t(e) {
                N(),
            ...
            function a() {
                ...
                if (t && ((1 == t.length && f.singleDate) || 2 <= t.length)) {
                    var a = f.format;
                    a.match(/Do/) && ((a = a.replace(/Do/, "D")), (t[0] = t[0].replace(/(\d+)(th|nd|st)/, "$1")), 2 <= t.length && (t[1] = t[1].replace(/(\d+)(th|nd|st)/, "$1"))),
                        (s = !1),
            ...
            function p(e) {
                ...
                return (
                    "week-range" === f.batchMode
                        ? (t = "monday" === f.startOfWeek ? Q(parseInt(e)).startOf("isoweek").valueOf() : Q(parseInt(e)).startOf("week").valueOf())
                        : "month-range" === f.batchMode && (t = Q(parseInt(e)).startOf("month").valueOf()),
                    t
                );
            }
            function v(e) {
                ...
                return (
                    "week-range" === f.batchMode
                        ? (t = "monday" === f.startOfWeek ? Q(parseInt(e)).endOf("isoweek").valueOf() : Q(parseInt(e)).endOf("week").valueOf())
                        : "month-range" === f.batchMode && (t = Q(parseInt(e)).endOf("month").valueOf()),
                    t
                );
            }
            function k(e) {
                    ...
                    if (
                        ...
                        f.singleDate
                            ...
                            ? "monday" === f.startOfWeek
                                ? ((f.start = Q(parseInt(t)).startOf("isoweek").valueOf()), (f.end = Q(parseInt(t)).endOf("isoweek").valueOf()))
                                : ((f.end = Q(parseInt(t)).endOf("week").valueOf()), (f.start = Q(parseInt(t)).startOf("week").valueOf()))
                            : "workweek" === f.batchMode
                            ? ((f.start = Q(parseInt(t)).day(1).valueOf()), (f.end = Q(parseInt(t)).day(5).valueOf()))
                            : "weekend" === f.batchMode
                            ? ((f.start = Q(parseInt(t)).day(6).valueOf()), (f.end = Q(parseInt(t)).day(7).valueOf()))
                            : "month" === f.batchMode
                            ? ((f.start = Q(parseInt(t)).startOf("month").valueOf()), (f.end = Q(parseInt(t)).endOf("month").valueOf()))
                            : (f.start && f.end) || (!f.start && !f.end)
                            ? ((f.start = p(t)), (f.end = !1))
                            : f.start && ((f.end = v(t)), f.time.enabled && h("end", f.end)),
                        f.time.enabled && (f.start && h("start", f.start), f.end && h("end", f.end)),
            ...
            function M() {
                ...
                f.singleDate
                    ...
                    ? ((f.start = !1), (f.end = !1), m.find(".day").removeClass("checked"), m.find(".drp_top-bar").removeClass("normal").addClass("error").find(".error-top").html(K("less-than").replace("%d", f.maxDays)))
                    : f.minDays && e < f.minDays
                    ? ((f.start = !1), (f.end = !1), m.find(".day").removeClass("checked"), m.find(".drp_top-bar").removeClass("normal").addClass("error").find(".error-top").html(K("more-than").replace("%d", f.minDays)))
                    : f.start || f.end
                    ? m.find(".drp_top-bar").removeClass("error").addClass("normal")
                    : m.find(".drp_top-bar").removeClass("error").removeClass("normal"),
                    ...
                    f.batchMode && ((f.start && f.startDate && H(f.start, f.startDate) < 0) || (f.end && f.endDate && 0 < H(f.end, f.endDate))) && ((f.start = !1), (f.end = !1), m.find(".day").removeClass("checked"));
            }
            function S(e, t) {
                var a;
                m.find(".start-day").html("..."),
                    ...
                    f.start && f.singleDate
                        ? (m.find(".apply-btn").removeClass("disabled"),
                          ...
                          s && !t && U(n).trigger("datepicker-change", { value: a, date1: new Date(f.start) }))
                        : f.start && f.end
                        ? (m.find(".selected-days").show().find(".selected-days-num").html(z(f.end, f.start)),
                          m.find(".apply-btn").removeClass("disabled"),
                          (a = W(new Date(f.start)) + f.separator + W(new Date(f.end))),
                          f.setValue.call(o, a, W(new Date(f.start)), W(new Date(f.end))),
                          s && !t && U(n).trigger("datepicker-change", { value: a, date1: new Date(f.start), date2: new Date(f.end) }))
                        : e
                        ? m.find(".apply-btn").removeClass("disabled")
            ...
            function j(e, t, a) {
                ...
                (f.start = e.getTime()),
                    ...
                    f.stickyMonths && !1 !== f.endDate && 0 < L(t, f.endDate) && ((e = R(e)), (t = R(t))),
                        ...
                        (function (e) {
                            ...
                            for (var d = e.getMonth(), o = 0; o < 40; o++)
                                (a = Q(e).add(o, "days").toDate()),
                                    ...
                                    t.push({ date: a, type: a.getMonth() == d ? "toMonth" : "nextMonth", day: a.getDate(), time: a.getTime(), valid: n });
            ...
            function E() {
                ...
                return "monday" == f.startOfWeek
                    ? e + "<th>" + K("week-1") + "</th><th>" + K("week-2") + "</th><th>" + K("week-3") + "</th><th>" + K("week-4") + "</th><th>" + K("week-5") + "</th><th>" + K("week-6") + "</th><th>" + K("week-7") + "</th>"
                    : e + "<th>" + K("week-7") + "</th><th>" + K("week-1") + "</th><th>" + K("week-2") + "</th><th>" + K("week-3") + "</th><th>" + K("week-4") + "</th><th>" + K("week-5") + "</th><th>" + K("week-6") + "</th>";
            }
            function q(e) {
            ...
            function _() {
                ...
                return (
                    f.lookBehind
                        ? (f.startDate && L(e, f.startDate) < 0 && (e = F(Q(f.startDate).toDate())), f.endDate && 0 < L(e, f.endDate) && (e = Q(f.endDate).toDate()))
                        : (f.startDate && L(e, f.startDate) < 0 && (e = Q(f.startDate).toDate()), f.endDate && 0 < L(F(e), f.endDate) && (e = R(Q(f.endDate).toDate()))),
                    f.singleDate && (f.startDate && L(e, f.startDate) < 0 && (e = Q(f.startDate).toDate()), f.endDate && 0 < L(e, f.endDate) && (e = Q(f.endDate).toDate())),
                    e
                );
            }
            function G(e) {
