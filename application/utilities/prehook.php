...
FatApplication::getInstance()->setControllersForStaticFileServer(array('images', 'img', 'fonts', 'templates', 'innovas', 'assetmanager', 'assets'));
...
FatApp::setViewDataProvider('_partial/footerUserLangArea.php', array('Common', 'footerUserLangArea'));
...
/*FatApp::setViewDataProvider('_partial/seller/sellerRentalGraph.php', array('Statistics', 'sellerRentalGraph'));*/
