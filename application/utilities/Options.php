...
trait Options
{
    ...
    private function getForm($option_id = 0)
    {
        ...
        $frm->addRequiredField(
                Labels::getLabel('LBL_OPTION_IDENTIFIER', $this->siteLangId), 'option_identifier'
        );
        ...
        $frm->addSelectBox(
                Labels::getLabel('LBL_OPTION_HAVE_SEPARATE_IMAGE', $this->siteLangId), 'option_is_separate_images', $yesNoArr, 0, array(), ''
        ...
        $frm->addCheckBox(Labels::getLabel('LBL_Attach_Size_Chart', $this->siteLangId), 'option_attach_sizechart', 1);
